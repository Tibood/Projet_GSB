...
<div class='container'>
    ...
    <div class="input-group">
        ...
        <br/>
        <input type="text" value='<?php echo $fraisForfait[0]['quantite']?>' id="Fofait_Etape" name="Fofait_Etape" required
            minlength="4" maxlength="8" size="10">
        <br/>
        <label>Frais Kilometrique</label>
        <br/>
        <input type="text" value='<?php echo $fraisForfait[1]['quantite']?>' id="Frais_Kilometrique" name="Frais_Kilometrique" required
            minlength="4" maxlength="8" size="10">
        <br/>
        <label>Repas Restaurant</label>
        <br/>
        <input type="text" value='<?php echo $fraisForfait[3]['quantite'] ?>' id="Repas_Restaurant" name="Repas_Restaurant" required
            minlength="4" maxlength="8" size="10">
    </div>
    <br/>
